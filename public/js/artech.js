...
const panorama1 = addPanorama("1x.jpg");
...
addFloor(panorama0, panorama1, 2500, -1750, 1250);

addFloor(panorama1, panorama0, 3000, -1750, 250);
addFloor(panorama1, panorama2, -2750, -1250, -1250);
addFloor(panorama1, panorama9, 1500, -1250, -3750);
...
addArt(panorama1, "0-1", 7000, 250, 2250);
addArt(panorama1, "0-2", 6250, 250, 2250);
addArt(panorama1, "0-3", 5750, 250, 2250);
addArt(panorama1, "0-4", 5000, 250, 2250);
addArt(panorama1, "0-5", 4250, 250, 2250);
addArt(panorama1, "0-6", 3500, 250, 2250);
addArt(panorama1, "0-7", 2750, 250, 2250);
addArt(panorama1, "0-8", 2750, 250, 3250);
addArt(panorama1, "1-1", -750, -750, -3000);
...
addArt(panorama3, "2-3", -6500, -1000, -250);
addArt(panorama3, "2-5", 1250, -1250, 5500);
addArt(panorama3, "3-1", 4000, -1000, 2500);
addArt(panorama3, "3-2", 5750, -1000, 2250);
addArt(panorama3, "3-3", 5000, -1000, 2500);
addArt(panorama3, "3-4", 6500, -1000, 2000);
addArt(panorama3, "3-5", -5000, -1000, -1500);
addArt(panorama3, "3-6", 8250, -1000, 2000);
addArt(panorama3, "2-4", 3000, -1000, -3200);
addArt(panorama3, "2-7", -1500, -1250, -3500);
addArt(panorama3, "2-6", -4250, -1250, -3250);
addArt(panorama3, "2-8", 1000, -1000, -3200);
addArt(panorama3, "3-11", 2500, -1000, 2500);

addArt(panorama4, "3-1", 2000, -750, 1000);
addArt(panorama4, "3-2", 3500, -1000, -250);
addArt(panorama4, "3-3", 3500, -1000, 500);
addArt(panorama4, "3-4", 4000, -1000, -1250);
addArt(panorama4, "3-6", 4250, -1000, -2000);
addArt(panorama4, "2-4", -2250, -1000, -1250);
addArt(panorama4, "2-8", -2750, -750, 250);
addArt(panorama4, "3-11", 1500, -750, 2000);
addArt(panorama4, "4-9", -250, -1500, 4750);
addArt(panorama4, "4-10", 1250, -1250, 3750);

addArt(panorama5, "3-4", -1750, -750, 0);
addArt(panorama5, "3-6", -1500, -750, 750);
addArt(panorama5, "5-3", -1250, -1000, 4250);
addArt(panorama5, "2-4", 3500, -1000, -2750);
...
addArt(panorama7, "6-3", 6250, -1250, -500);
...
addArt(panorama9, "1-1", 2750, -250, -4000);
...
addArt(panorama9, "9-10", 2250, -750, 1000);
addArt(panorama9, "9-11", 3000, -1250, 3000);
addArt(panorama9, "9-12", 6250, -1000, -3500);
addArt(panorama9, "9-13", 6250, -1000, -4750);
addArt(panorama9, "9-14", 7000, -2000, 1500);
addArt(panorama9, "9-15", 4250, 1000, 4000);
addArt(panorama9, "9-16", 5500, 1000, 1750);
addArt(panorama9, "9-17", 4000, -1250, 2750);
addArt(panorama9, "9-18", 3750, -750, -750);
addArt(panorama9, "9-19", 3750, -750, 0);
addArt(panorama9, "9-20", 5000, -1000, -2000);
addArt(panorama9, "9-21", 5000, 1000, 3250);