...
// ADD FOCUS
// 3250, -250, 1750
const start = new PANOLENS.Infospot();
start.position.set(3250, -250, 1750);
start.addHoverText(
	"Olimpus 2021 proudly presents:\nArt and Technology Paradise"
);
start.hide();
panorama0.add(start);
panorama0.addEventListener("load", function () {
	start.focus();
});

// MENAMBAHKAN FLOOR KE PANORAMA
addFloor(panorama0, panorama1, 2500, -1500, -3500);

addFloor(panorama1, panorama0, 2250, -2250, -3000);
addFloor(panorama1, panorama9, -3000, -1000, -1250);
addFloor(panorama1, panorama2, 500, -1750, 4250);

addFloor(panorama2, panorama1, -3250, -1750, 2500);
...
addArt(panorama2, "2-1", 5000, -750, -1250);
addArt(panorama2, "2-2", 3500, -1250, 4000);
addArt(panorama2, "2-3", 5500, -1000, -3500);
addArt(panorama2, "2-4", 7500, -1000, 6500);
addArt(panorama2, "2-5", -250, -1750, 6500);
addArt(panorama2, "2-6", 5250, -750, 0);
addArt(panorama2, "2-7", 7250, -1000, 2000);
addArt(panorama2, "2-8", 5250, -750, 3000);
...
addArt(panorama3, "3-7", 3000, -1000, -3200);
addArt(panorama3, "3-8", -1500, -1250, -3500);
addArt(panorama3, "3-9", -4250, -1250, -3250);
addArt(panorama3, "3-10", 1000, -1000, -3200);
