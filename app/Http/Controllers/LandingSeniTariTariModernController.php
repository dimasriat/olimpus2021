...
class LandingSeniTariTariModernController extends Controller
{
	...
	public function store(Request $request) {
		...
		$nama_file = [
			'ktm' => [
				'peserta_1' => $ktm_peserta_1 ? $ktm_peserta_1->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_2' => $ktm_peserta_2 ? $ktm_peserta_2->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_3' => $ktm_peserta_3 ? $ktm_peserta_3->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_4' => $ktm_peserta_4 ? $ktm_peserta_4->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_5' => $ktm_peserta_5 ? $ktm_peserta_5->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
			'foto' => [
				'peserta_1' => $foto_peserta_1 ? $foto_peserta_1->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_2' => $foto_peserta_2 ? $foto_peserta_2->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_3' => $foto_peserta_3 ? $foto_peserta_3->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_4' => $foto_peserta_4 ? $foto_peserta_4->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'peserta_5' => $foto_peserta_5 ? $foto_peserta_5->store('senibudaya/senitari/tarimodern/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
		];
